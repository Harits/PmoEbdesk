...
**Actor**: Board of Director
**Description**: The user searches for specific projects by name and filters them by health status to get granular details.
**Pre-conditions**: User is authenticated.
**Post-conditions**: A filtered list of project cards is displayed.
